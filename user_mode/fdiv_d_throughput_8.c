...
__asm__ __volatile__("fdiv d5, d9, d14");
__asm__ __volatile__("fdiv d6, d9, d15");
__asm__ __volatile__("fdiv d7, d9, d16");
__asm__ __volatile__("fdiv d8, d9, d17");
__asm__ __volatile__("fdiv d1, d9, d10");
__asm__ __volatile__("fdiv d2, d9, d11");
__asm__ __volatile__("fdiv d3, d9, d13");
__asm__ __volatile__("fdiv d4, d9, d13");
...
__asm__ __volatile__("fdiv d8, d9, d17");
    ...
    write_to_csv("fdiv_d", "8", cycles_per_instruction);
